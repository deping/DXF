...
namespace DXF
{
	...
	*/
	...
	struct DXF_API AcadDim : public EntAttribute
	{
		...
		//标注文字的中点（在 OCS 中）
		// m_ValidMembersFlag[TEXTPOSITION]指示这个变量是否有效
		...
		//用来指示m_DimStyleOverride中某个成员变量(Name除外)/m_TextRotation/m_TextPosition的值是否有效。
		...
		// m_ValidMembersFlag[TEXTROTATION]指示这个变量是否有效
